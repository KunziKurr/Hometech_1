           ...
           <!-- <img src="<?php echo ROOT_URL; ?>/images/Lexus.png" alt="" class="slideshow_img"> -->
              <div class="slideshow_heading">
                        ...
                        <p class="slideshow_content"> 
                            ...
                            Talk to us, we'll be happy to tacle your problem and give you a quick and the
                            perfect solution  for you business and endeavours
                        </p>
...
<div class="features ">
    ...
    <div class="features-wrapper">
        ...
        <img class="features_img" src="<?php echo ROOT_URL;?>/images/assets/_connections.svg">
          ...
          Ut facere labore harum iure obcaecati dolor id! Praesentium fuga ratione 
          libero dignissimos aliquid at, 
          ipsum minima voluptas distinctio illo neque porro? 
          </p>
          <a href="#" class="btn btn-maroon_blue">Check Out</a>
        </div>
...
<h2 class="features-heading-sudo">Contact Us  </h2>
    <div class="conversate-wrapper">
        <form action="<?php $_SERVER['PHP_SELF']; ?>" class="contact-sudo" method="POST">
          <div class="contact-form_holder">
          <label for="email" class="contact-form-label">Email Address</label>
            <input type="email" placeholder="Email ..." required class="contact-form-input inline-form">
          </div>

          <div class="contact-form_holder">
          <label for="Subjects" class="contact-form-label">Subject</label>
            <input type="text" placeholder="Enter Subjects" required class="contact-form-input inline-form">
            </div>
            
            <div class="contact-form_holder">
            <label for="message" class="contact-form-label">Message</label>
            <textarea name="message"   cols="30" rows="3" class="contact-form-input textarea"  placeholder="Enter Message...">
            </textarea>
            </div>
            <button type="submit" class="btn btn-transparent">Send Message</button>
      </form>
    </div>
</div>
...
<?php include 'include/footer_template.php' ?>